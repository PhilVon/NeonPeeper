...
- **Web Crypto API** — Ed25519 signing, TOFU key pinning, PBKDF2 + AES-GCM encrypted key storage
...
Messages are signed with Ed25519 when signing is enabled. Error responses use structured codes (1000-5099) covering connection, message, chat, media, and security categories.
